    ...
    <div className={styles.pageContainer}>
      ...
      <div className={styles.editorWrapper}>
        ...
        <aside className={styles.sidebar}>
          ...
          <div className={styles.formGroup}>
            <label htmlFor="quizCategory">Category ID</label>
            <input
              id="quizCategory"
              className={styles.input}
              type="number"
              placeholder="Enter a category ID"
              value={quizInfo.categoryId === 0 ? '' : quizInfo.categoryId}
              onChange={(e) => setQuizInfo({ ...quizInfo, categoryId: Number(e.target.value) || 0 })}
            />
          </div>
        </aside>
